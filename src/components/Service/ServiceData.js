const ServiceData = {
  ...
  Service: [
    {
      ...
      icon: "ti-panel",
      text: "MEET NEW BRANDS",
      description:
        "Meet more social brands and choose between them that you want to work with.",
      btn: "Read More",
    ...
    },
    {
      ...
      text: "FICTION & BRİEF SUPPORT",
      description:
        " If you are struggling to find fiction for the campaign, we have a staff of experts who can help you.",
      btn: "Read More",
      bicon: "ti-arrow-right",
    },
    {
      ...
      description:
        "Extensive social media network such as Youtube, Instagram, Facebook, Twitter, Tik tok, Blogger, Twitch, Snapchat",
      btn: "Read More",
      bicon: "ti-arrow-right",
    },
    {
      ...
      icon: "ti-fullscreen",
      text: "SPECIAL WORKSHOPS",
      description:
        "Participate in workshops offered by talented and experienced influencers and meet new people",
      btn: "Read More",
      bicon: "ti-arrow-right",
    },
  ],
  ...
  HRService: [
    ...
    {
      id: "2",
      HRtitles: "FICTION & BRİEF SUPPORT",
      HRdescription:
        "If you are struggling to find fiction for the campaign, we have a staff of experts who can help you.",
      Hicon: "layout-grid2",
      rclass: "pl_50 pr_20",
    ...
    {
      id: "5",
      HRtitles: "EVENTS AND INVITATIONS",
      HRdescription:
        "The Influencer agency provides you with a free invitation to participate in events and events.",
      Hicon: "cloud-down",
      rclass: "pl_50 pr_20",
      iclass: "icon_five",
    },
    {
      id: "6",
      HRtitles: "EASE OF RECEIVING PAYMENTS",
      HRdescription:
        "Your payments are credited to the bank account you specified.",
      Hicon: "bolt",
      rclass: "pl_70",
      iclass: "icon_six",
    },
