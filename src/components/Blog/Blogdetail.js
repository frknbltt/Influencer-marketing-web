...
const Blogdetail = () => {
  ...
  return (
    <section style={{ paddingTop: "0" }} className="blog_area sec_pad">
      <div className="container">
        <div className="row">
          <div>
            <div
              className="blog_single mb_50"
              style={{
                display: "flex",
            ...
            >
              <img className="img-fluid" src={selectedPost.image} alt="" />
              <div className="blog_content">
                <div className="post_date">
                  <h2>{Math.floor(Math.random() * 31)}</h2>
                </div>
